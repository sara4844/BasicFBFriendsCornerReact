...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RouteUtils = __webpack_require__(171);
	...
	var _PatternUtils = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InternalPropTypes = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createHashHistory = __webpack_require__(180);
	...
	var UserIs = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                "div",
	                { className: "ui vertical raised primary teal segment" },
	                React.createElement(
	                    "h2",
	                    { className: "ui center aligned icon header" },
	                    React.createElement("i", { className: "circular users icon" }),
	                    "Basic Profiler"
	                ),
	                React.createElement(
	                    "div",
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "ui right action left icon input" },
	                        React.createElement("i", { className: "users icon" }),
	                        React.createElement("input", { type: "text", value: this.state.username, onChange: this.update,
	                            placeholder: "Search by username" }),
	                        React.createElement(
	                            Link,
	                            { to: "Profile/" + this.state.username, className: "ui floating link button" },
	                            React.createElement("i", { className: "inverted circular search link icon" })
	                        )
	                    )
	                )
	            ),
