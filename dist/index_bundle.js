...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasicFBFriendsCorner = __webpack_require__(169);
	ReactDOM.render(React.createElement(BasicFBFriendsCorner, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var React = __webpack_require__(2);
	var UserIs = __webpack_require__(170);
	var Profile = __webpack_require__(171);

	var BasicFBFriendsCorner = React.createClass({
	    displayName: "BasicFBFriendsCorner",
	    ...
	    addProfile: function addProfile(friendsList) {
	        var profile = {};
	    ...
	    render: function render() {
	        return React.createElement(
	            "div",
	            null,
	            React.createElement(UserIs, { user: this.changeUser }),
	            this.state.username ? React.createElement(Profile, { friendsData: this.state.profiles,
	...
	var UserIs = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            "div",
	            null,
	            React.createElement("input", { type: "text", value: this.state.username, onChange: this.update, placeholder: "Search profiles by username" }),
	            React.createElement(
	                "button",
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var UserLookup = __webpack_require__(172);
	var NoFriendsToShow = __webpack_require__(173);
	var AddFriend = __webpack_require__(174);
	var ShowList = __webpack_require__(175);
	...
	var Profile = React.createClass({
	    ...
	    getInitialState: function getInitialState() {
	        return {
	            userFound: false,
	            friendsList: this.props.friendsData.hasOwnProperty(this.props.user) ? this.props.friendsData[this.props.user] : []
	        };
	    },
	    onFriendsFound: function onFriendsFound(value) {
	        this.setState({
	            userFound: value
	        });
	    },
	    addFriends: function addFriends(friend) {
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(UserLookup, { friends: this.props.friendsData, username: this.props.user, onLookup: this.onFriendsFound }),
	            this.state.userFound ? React.createElement(ShowList, { friends: this.state.friendsList }) : React.createElement(NoFriendsToShow, { username: this.props.user }),
	            React.createElement(AddFriend, { onAdd: this.onFriendsFound, addFriend: this.addFriends })
	        );
	    }
	});
	...
	var AddFriend = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            "div",
	            null,
	            React.createElement("input", { type: "text", value: this.state.text, onChange: this.handleInput }),
	            React.createElement(
	                "button",
	                { onClick: this.add },
	                "Add Friend"
